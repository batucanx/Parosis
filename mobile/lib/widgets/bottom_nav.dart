...
final _tabs = [
  _TabDef('home', 'Ana Sayfa', ({size = 24.0, color = Colors.black}) => AppIcons.home(size: size, color: color)),
  _TabDef('balance', 'Bakiyem', ({size = 24.0, color = Colors.black}) => AppIcons.wallet(size: size, color: color)),
  _TabDef('profile', 'Profil', ({size = 24.0, color = Colors.black}) => AppIcons.user(size: size, color: color)),
];
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: selected
              ? [
                  BoxShadow(
                    color: const Color(0xFF115A4B).withOpacity(0.85),
                    blurRadius: 16,
                    spreadRadius: -6,
        ...
        child: Column(
          ...
          children: [
            tab.icon(size: 20, color: selected ? Colors.white : AppColors.inkSoft),
